...
export const SITE_COPY = {
  en: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          eyebrow: "06",
          title: "Catch dates",
          caption: "Label Gmail as Cygnet and send detected interview dates to Calendar.",
        },
      ],
      trustCues: [
    ...
    applications: {
      ...
      googleConnectedDesc: "Calendar actions and Gmail label sync are ready for this account.",
      googleFounderNote:
        "Founder note: Calendar and Gmail sync are still in beta. Please review detected dates before relying on them.",
      ...
      googleLabelValue: "Tracking Gmail label: {label}",
      googleLastSynced: "Last synced: {date}",
      autoCalendarToggle: "Add Gmail-detected dates to Google Calendar",
      autoCalendarOn: "Detected dates will be added automatically.",
      autoCalendarOff: "Detected dates will stay in Cygnet only.",
      ...
      gmailSyncResult: "Imported {imported} new threads, updated {updated} applications, and synced {calendar} Calendar events.",
  ...
  ja: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          eyebrow: "06",
          title: "日程を拾う",
          caption: "Gmail に Cygnet ラベルを付けると面接日程を Calendar に送れます。",
        },
      ],
      trustCues: [
        "送信前に確認できます",
    ...
    applications: {
      ...
      googleConnectedDesc: "このアカウントでは Google Calendar と Gmail 同期が使える状態です。",
      googleFounderNote:
        "開発者メモ: Calendar と Gmail 同期はまだベータ版です。検出された日程は必ず確認してください。",
      ...
      googleLabelValue: "追跡ラベル: {label}",
      googleLastSynced: "最終同期: {date}",
      autoCalendarToggle: "Gmailで見つけた日程をGoogle Calendarに追加",
      autoCalendarOn: "検出した日程は自動でCalendarに追加されます。",
      autoCalendarOff: "検出した日程はCygnet内だけに保存されます。",
      autoCalendarSaving: "カレンダー設定を更新中...",
      autoCalendarSaved: "カレンダー設定を更新しました。",
      autoCalendarError: "カレンダー設定を更新できませんでした。",
      gmailSyncing: "Gmailを同期中...",
      gmailSyncResult: "{imported}件を新規追加し、{updated}件を更新し、{calendar}件をCalendarに反映しました。",
