...
export const SITE_COPY = {
  en: {
    ...
    applications: {
      ...
      googleDesc: "Connect Google once to send follow-ups to Calendar and auto-sync Gmail messages labeled Cygnet.",
  ...
  ja: {
    ...
    applications: {
      ...
      googleDesc: "Google を一度連携すると、Calendar 追加と Gmail の Cygnet ラベル自動同期が使えます。",
